...
export const meta: MetaFunction = () => {
  return [{ title: "Demo" }, { name: "description", content: "" }];
};
...
export default function Index() {
  ...
  //   const contract = new ethers.Contract("0x180d53A1cb238098Af864cB3e942f236D0D0f79F", treasuryAbi.abi);
      ...
      <div className="flex flex-col items-center gap-16">
        <header className="flex flex-col items-center gap-9">
          ...
          <div className="h-[144px] w-[434px]">
            ...
            {/* <button onClick={() => onGetAuth()}>get auth</button> */}
            <button onClick={() => addDonor()}>add donor</button>
            <button onClick={() => addResearcher()}>add researcher</button>
            <button onClick={() => propose()}>add proposal</button>
            <button onClick={() => onGetProposals()}>get proposal</button>
            </div>
            <img
              src="/logo-light.png"
              alt="Remix"
